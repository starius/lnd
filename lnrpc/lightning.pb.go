...
const file_lightning_proto_rawDesc = "" +
	...
	"\x04LOST\x10\x02\"\x1a\n" +
	"\x18ChannelEventSubscription\"\xff\x04\n" +
	...
	"\x16fully_resolved_channel\x18\a \x01(\v2\x13.lnrpc.ChannelPointH\x00R\x14fullyResolvedChannel\x128\n" +
	"\x04type\x18\x05 \x01(\x0e2$.lnrpc.ChannelEventUpdate.UpdateTypeR\x04type\"\x92\x01\n" +
	"\n" +
	"UpdateType\x12\x10\n" +
	...
	"\x16FULLY_RESOLVED_CHANNEL\x10\x05B\t\n" +
	"\achannel\"t\n" +
	...
	"\x13custom_channel_data\x18\t \x01(\fR\x11customChannelData\"\x9a\a\n" +
	...
	"\x10outgoing_chan_id\x18\x0e \x01(\x04B\x020\x01R\x0eoutgoingChanId\x12&\n" +
	...
	"\ttime_pref\x18\x12 \x01(\x01R\btimePref\x1aD\n" +
	"\x16DestCustomRecordsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x04R\x03key\x12\x14\n" +
	...
	"\fsettle_index\x18\x02 \x01(\x04R\vsettleIndex\"\xcb\x06\n" +
	"\aPayment\x12!\n" +
	...
	"\aactions\x18\x02 \x03(\tR\aactions\"\x8e\x01\n" +
	...
	" UPDATE_FAILURE_INVALID_PARAMETER\x10\x042\xc3'\n" +
	"\tLightning\x12J\n" +
	...
	"\x11SubscribeInvoices\x12\x1a.lnrpc.InvoiceSubscription\x1a\x0e.lnrpc.Invoice0\x01\x122\n" +
