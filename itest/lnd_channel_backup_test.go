...
func assertPenalty(ht *lntest.HarnessTest,
	...
	require.Eventually(ht, func() bool {
		// To fail fast if there is more than 1 transaction, wait for
		// at least 1 transaction here. If there is more than one tx,
		// the MineBlocksAndAssertNumTxes call below will fail.
		return len(ht.Miner.GetRawMempool()) >= 1
