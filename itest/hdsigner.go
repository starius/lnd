...
// hdSigner generates raw signatures as well as full complete input scripts
// given a valid SignDescriptor and transaction.
...
// signOutputRawWithPrivateKey generates a signature for the passed transaction
...
// FetchPrivateKey returns a private key according to the passed descriptor.
...
var _ input.Signer = (*hdSigner)(nil)
